...
#    path('admin/', admin.site.urls), # already defined in project views
    ...
    path('zip/<page_url>/latest/<str:directory>/<str:page>', views.zipview, name='zipview',),
    path('zip/<page_url>/latest/<str:directory>/<str:subdirectory>/<str:page>', views.zipview, name='zipview',),
    path('zip/<page_url>/latest/<str:directory>/<str:subdirectory>/<str:subsubdir>/<str:page>', views.zipview, name='zipview',),
    path('zip/<page_url>/latest/<str:directory>/<str:subdirectory>/<str:subsubdir>/<str:subsubsubdir>/<str:page>', views.zipview, name='zipview',),
]
